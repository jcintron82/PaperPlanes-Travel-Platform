...
export const HotelQueryModal = () => {
  ...
  return (
    <div>
      {selectFlight === false ? (
        <CSSTransition in={hotelSelected} timeout={300} classNames="fade">
          <div
            className={
              isLoading ? "mainsearchwrap pageopacity" : "mainsearchwraphotel"
            }
          >
                ...
                >
                  <div className="dateselectionwrap">
                    <input
                      ...
                      required
                      onChange={(e) =>
                        updateDatesAndFilters(e, "departureDate")
                      }
                      type="date"
                    ></input>
                    <input
        ...
        <CSSTransition in={selectFlight} timeout={400} classNames="fade">
          <FlightSearchModal />
        </CSSTransition>
      )}
    </div>
...
export default HotelQueryModal;
